...
<p align="center"><img width="500" height="auto" src="https://github.com/MS930/ms930.github.io/blob/master/iamge/projection.png?raw=true"></p>
...
$$ 
{\min{ L_{p}(w,b,{ \alpha }_{ i }) } } =\frac { 1 }{ 2 } { \left| w \right| }{ 2 }^{ 2 }-\sum { i=1 }^{ n }{ { \alpha }{ i }({ y }{ i }({ w }^{ T }{ x }{ i }+b)-1) } 
$$
